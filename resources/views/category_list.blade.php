            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Categories
                        <div><a href="/tts/categories/manage" class="btn btn-success">Add New Item</a></div>
                    </div>
                            ...
                            @foreach($data as $dataItem)
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" class="listcontent"><a
                                                href="/tts/categories/manage?id={{$dataItem->id}}" class="link"
                                                id="link"><span id="Lable" class="Lable">{{$dataItem->title}}</span></a>
                                    </td>
                                    <td colspan="1" class="listcontent">
                                        <div class="operationspart">
                                            <a href="/tts/categories/delete?id={{$dataItem->id}}" class="btn btn-danger"
